...
__kernel void augmentmatrix_forward(__global float *outp, __global float *inp, __global float *pars, int numPics, int inputWidth, int outputWidth, int numConvolutions, int x1, int x2, int batchSize)
{
	int tid = get_global_id(0);
...
__kernel void augmentmatrix_backward(__global float *dinp, __global float *dpars, __global float *doutp, __global float *outp, __global float *inp, __global float *pars, int numPics, int inputWidth, int outputWidth, int numConvolutions, int x1, int x2, int batchSize)
{
	int tid = get_global_id(0);
